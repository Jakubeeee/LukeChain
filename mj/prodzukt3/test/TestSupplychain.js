...
contract('SupplyChain', accounts => {
    ...
    it("Test adding addresses to roles groups", async () => {
        ...
        let farmerAddedEvent = await instance.addFarmer(originFarmerID);
        truffleAssert.eventEmitted(farmerAddedEvent, 'FarmerAdded');

        let distributorAddedEvent = await instance.addDistributor(distributorID);
        truffleAssert.eventEmitted(distributorAddedEvent, 'DistributorAdded');

        let retailerAddedEvent = await instance.addRetailer(retailerID);
        truffleAssert.eventEmitted(retailerAddedEvent, 'RetailerAdded');

        let consumerAddedEvent = await instance.addConsumer(consumerID);
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async () => {
        ...
        const tx = await instance.harvestItem(upc, originFarmerID, originFarmName, originFarmInformation, originFarmLatitude, originFarmLongitude, productNotes, {from: ownerID})
